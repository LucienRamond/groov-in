...
export default function Navbar() {
  ...
  return (
    <div className=" flex justify-between border-b bg-neutral-900">
      <List className=" flex">
        <ListItem>
          <ListItemIcon className=" flex justify-center">
            <div className=" flex gap-[2px]">
              <ListItemText className=" text-white" primary="GR" />
              <CirclePlay className=" my-auto" color="white" />
              <CirclePause className=" my-auto" color="white" />
              <ListItemText className=" text-white" primary="V'IN" />
            </div>
          </ListItemIcon>
        </ListItem>
